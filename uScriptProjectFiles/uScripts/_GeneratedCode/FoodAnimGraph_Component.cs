...
[AddComponentMenu("uScript/Graphs/FoodAnimGraph")]
public class FoodAnimGraph_Component : uScriptCode
{
   #pragma warning disable 414
   public FoodAnimGraph ExposedVariables = new FoodAnimGraph( ); 
      ...
      {
         {
            ...
            gameObject = GameObject.Find( "YoMamaMouth" ); 
